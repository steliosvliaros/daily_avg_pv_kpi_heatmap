...
class WorkspaceConfig:
    ...
    def __init__(self, workspace_root: Optional[Path] = None):
        ...
        self.PVGIS_OUTPUT_TYPICAL_DAILY = self.PVGIS_OUTPUT / "pvgis_typical_daily.parquet"
    ...
    def get_all_directories(self) -> list[Path]:
        ...
        return [
            ...
            self.OUTPUTS_DIR,
            self.GOLD_DIR,
            self.GOLD_DAILY_ENERGY,
            self.GOLD_DAILY_ENERGY_OPS,
            self.GOLD_PVGIS_REFERENCE,
            self.GOLD_PVGIS_REFERENCE_OPS,
            self.REPORTS_DIR,
        ]
